            ...
            <table class="table table-striped">
               <thead>
                  <tr>
                     ...
                     <th style="background-color: #acd5b8; text-align: center;">작성자(이름)</th>
                     <th style="background-color: #acd5b8; text-align: center;">작성자(이메일)</th>
                     <th style="background-color: #acd5b8; text-align: center;">작성일</th>
                     <th style="background-color: #acd5b8; text-align: center;">파일</th>
                  </tr>
               </thead>
               <tbody>
                  <%
                  ...
                  <tr>
                     ...
                     <td style="background-color: #d2e7d6; text-align: center;"><%= list.get(i).getName() %></td>

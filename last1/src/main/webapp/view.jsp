   ...
   <div class="col-md-12">
      <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd"><br />
         ...
         <tbody>
            ...
            <tr>
               <td style="width:20%; background-color: #d2e7d6;">작성자(name)</td>
               <td colspan="2"><%= bbs.getName() %></td>
            </tr>
            <tr>
               <td style="width:20%; background-color: #d2e7d6;">작성자(email)</td>
...
<!--             <tr> -->
<!--                <td style="width:20%; background-color: #d2e7d6;">파일</td> -->
<%--                <td colspan="2"><%= file.getName() %></td> --%>
<!--             </tr> -->
      ...
      <%
         if(id != null && id.equals(bbs.getEmail())) {
      %>
							...
							<table class="table table-striped"
								...
								<tbody>
									<tr>
										...
										<td align="right"><%=list.get(i).getPostdate().substring(0, 11) + list.get(i).getPostdate().substring(11, 13)
											+ "시" + list.get(i).getPostdate().substring(14, 16) + "분"%></td>
									</tr>

									<tr>
										<td align="left"><%=list.get(i).getCommentContent()%></td>
										<td align="right">
											<a href="commentUpdate.jsp?num=<%=num%>&commentID=<%=list.get(i).getCommentID()%>"
											class="btn btn-warning">수정</a> 
											<a onclick="return confirm('정말로 삭제하시겠습니까?')"
											href="commentDeleteAction.jsp?num=<%=num%>&commentID=<%=list.get(i).getCommentID()%>"

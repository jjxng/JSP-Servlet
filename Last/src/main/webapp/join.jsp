						...
						<div class="text-center">
							...
							<form action="joinAction.jsp" method="post">
								...
								<div class="input-group mt-4">
									...
									<input type="password" class="form-control rounded-5 w85" placeholder="비밀번호를 적어주세요." name="pass" maxlength="10">
								</div>
								
								<div class="input-group mt-4">
									<label class="input-group-text w15">이름</label>
									<input type="text" class="form-control rounded-5 w85" placeholder="이름을 적어주세요." name="name" maxlength="30">
								</div>
								<div class="input-group mt-4">
									<label class="input-group-text w15">이메일</label>
									<input type="text" class="form-control rounded-5 w85" placeholder="이메일을 적어주새요." name="email" maxlength="30">
								</div>
								<div class="input-group mt-4">

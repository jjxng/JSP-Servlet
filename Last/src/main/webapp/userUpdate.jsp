...
<!-- 				<img src = "img/slide/강아지2.jpg" alt="My Image" width="60%" height ="100px"/> -->
				<div class="col-lg-7">
					<div class="p-5">
...
<!-- 									</div> -->
							<div class = "form-group mt-4">
								<label class="input-group-text w15">아이디</label>
									<input type="text" class="form-control rounded-5 w10" value=<%=user.getId()%> name="id" maxlength="10" disabled>
							</div>
							<div class="form-group">
								<label class="input-group-text w15">비밀번호</label>
									<input type="password" class="form-control rounded-5 w50" value=<%=user.getPass()%> name="pass" maxlength="10">
							</div>
							<div class="form-group">
								<label class="input-group-text w15">이름</label>
									<input type="text" class="form-control rounded-5 w85" value=<%=user.getName()%> name="name" maxlength="20">
							</div>
							<div class="form-group">
								<label class="input-group-text w15">이메일</label>
									<input type="text" class="form-control rounded-5 w85" value=<%=user.getEmail()%> name="email" maxlength="20">
							</div>

...
<body>
	...
	<!-- 
		...
		디렉토리 하위에 프로젝트와 동일한 톰켓 환경을 만들어서 복사본 파일을
		실행한다. 따라서 아래의 물리적경로는 .metadata하위의 경로가 출력된다.
	 -->
	...
	/*
		...
		내장객체는 _jspService() 메서드 내에서 생성된 지역변수 이므로
		더 넓은 지역인 선언부에서 사용하면 매개변수로 전달받아야 한다.
	*/

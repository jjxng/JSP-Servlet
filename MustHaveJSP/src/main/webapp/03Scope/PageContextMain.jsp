...
/*
	...
	Object를 기반으로 저장되므로 차후 값을 읽을 때는 해당 타입으로 형변화해야 한다.
*/
%>
<title>page 영역</title>
</head>
<body>
	...
	<%
	// 정수 데이터를 읽을 때는 Integer클래스를 통해 자동 언박싱 한다.
	...
	%>
	<ul>
	<!--  Java의 기본 클래스인 경우 별도의 처리없이 즉시 내용을 출력할 수 있다. -->
	...
	<!-- 
		...
		공유되지 않는다. 즉, 아래의 링크를 통해 이동한 페이지에서는 아무런 내용이
		출력되지 않는다.
	 -->

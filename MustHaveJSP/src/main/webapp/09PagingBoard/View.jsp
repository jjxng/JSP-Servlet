...
// 게시물 삭제를 위한 JS함수
function deletePost() {
	// conform()함수는 대화창에서 "예"를 누를 때 true가 반환된다.
	...
	<input type="hidden" name="num" value="<%= num %>" />  
	    <table border="1" width="90%">
	        ...
	        <tr>
	            ...
	            <!-- 
	            	입력시 줄바꿈을 위한 엔터는 \r\n으로 입력된다.
	            	따라서 웹브라우저에 출력시에는 <br> 태그로 변경해야 한다.
	             -->
	        ...
	        <tr>
            	...
            	<%
            	/*
            		로그인 된 상태에서, 세션영역에 저장된 아이디가 해당 게시물을
            		작성한 아이디와 일치하면 수정, 삭제 버튼을 보이게 처리한다.
            		즉, 작성자 본인이 해당 게시물을 조회했을 때만 수정, 삭제
            		버튼이 보이게 처리한다.
            	*/

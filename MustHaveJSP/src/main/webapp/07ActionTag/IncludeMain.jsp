...
<body>
	...
	<!-- 
		지시어를 이용한 인클루드의 경우 페이지의 경로는 문자의 형태로만 기술할 수 있다.
	...
	<!-- 
		지시어를 통한 인클루드는 포함한 파일의 소스를 그대로 현재문서에 포함시킨 후
	...
	<!-- 
		액션태그를 이용한 인클루드는 문자열과 표현식 2가지 모두 사용할 수 있다.
	 -->
	<jsp:include page="./inc/OuterPage2.jsp" />
	<jsp:include page="<%=outerPath2%>" />
	
	<!-- 
		액션태그를 통한 인클루드는 포함한 파일을 먼저 실행(컴파일)한 후 실행된
		결과를 해당 문서에 포함시킨다. 따라서 외부 파일에서 선언한 변수를 현재
		페이지에서 사용할 수 없게 된다.
	 -->

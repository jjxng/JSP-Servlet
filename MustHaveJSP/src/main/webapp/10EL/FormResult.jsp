...
<head>
<meta charset="UTF-8">
<title>표현 언어(EL) - 폽값 처리</title>
</head>
<body>
	<!-- 
		폼값으로 전송된 파라미터를 받을 때 EL의 내장객체를 사용할 수 있다.
		param : 단일값을 받을 때 사용한다.
		paramValues : 2개 이상의 값을 받을 때 사용한다. 단, 이 경우 배열을 통해
			값을 구분해야 한다.
	 -->
	<h3>EL로 폼값 받기</h3>
	<ul>
		...
		<!-- 
			...
			NullPointException이 발생하지 않으므로 아래와 같이
			기술해도 문제없다.
		 -->
	...
	/*
		...
		예외처리를 해야되므로 EL에 비해서는 불편한 점이 있다.
	*/
	%>
</body>
</html>
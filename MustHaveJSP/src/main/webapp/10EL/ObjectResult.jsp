...
<body>
	...
	<!-- 
		...
		즉, requestScope.perdonObject.name 형태로 기술하지 않아도 된다.
	 -->
	<ul>
	<!-- 
		"속성명.멤버변수"형태로 기술하면 객체에 선언된 getter()메서드를 자동으로
		호출하여 값을 출력한다. 즉, 아래의 문장은 getter()를 호출하므로 Person
		클래스에서 getName()을 주석처리 하면 에러가 발생한다.
	...
	<ul>
		<!-- EL에서 산술연사이 가능하므로 아래에서는 30이 출력된다. 

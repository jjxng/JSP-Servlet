...
<body>
	<!-- 
		액션 태그를 통해 공통링크로 사용할 페이지를 인클루드하여 해당 문서에
		포함시킨다.
	 -->
	...
	<h2>로그인 페이지</h2>
	<!-- 
		삼항연산자를 통해 request영역에 저자오딘 속성값이 있는 경우에만 에러메세지를
		화면에 출력한다. 
	...
	<%
	/*
		세션 영역에 UserId라는 속성값이 없는 경우, 즉 로그인 처리가 되지 않은
	...
	*/
	...
	<!-- 
		...
		이벤트 리스너로 구성한다. 특히 폼값검증을 위한 validateForm() 함수 호출 시
	...
	<%
		...
		/*
			session영역에 저장된 속성값이 있다면 로그인된 상태이므로 회원정보 및
			로그아웃 버튼을 화면에 출력한다.
		*/
	%>

...
<body>
<!-- 
	choose태그 : 하위에 when, otherwise태그를 가지고 있다. 여러 조건이 있는 경우
		사용하기에 적합하다.
 -->
	<!-- 변수 선언 -->
	...
	<!-- choose태그와 when태그 사이에 HTML주석을 기술하면 에어가 발생한다.
	...
	<!-- 국, 영, 수 3과목 모든 점수를 입력해야지만 조건에 만족하므로 하나라도
	입력되지 않으면 평균 점수는 출력되지 않는다. -->

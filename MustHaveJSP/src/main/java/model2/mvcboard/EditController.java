...
{
	// 수정 페이지로 진입해서 기존 내용은 수정폼에 설정한다.
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
			throws ServletException, IOException
	{
		// 수정 페이지로 전달된 일련번호를 통해 게시물을 인출한다.
			...
			throws ServletException, IOException
	{
		...
		/*
		 	...
		 	update쿼리 실행시 where조건으로 추가된다.
		 	즉, 검증이 완료된 사용자만 게시물을 추가할 수 있다.
		*/
		...
		// 수정 페이지에서 첨부한 파일이 있는 경우 파일명을 변경한다.

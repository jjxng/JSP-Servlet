...
public class MemberAuth extends HttpServlet
{
	...
	public void init() throws ServletException {
		...
		/*
		 	...
		 	서블릿이 먼저 요청을 받기 때문에 모델1 방식과 같기 JSP에서 매개변수로
	...
	/*
	 	service()메서드는 get방식, post방식 둘 다 요청을 받을 수 있으므로 해당
	 	메서드내에서 요청을 처리할 수 있다.
	*/
	@Override
			...
			throws ServletException, IOException
	{
		...
		*/
		...
		// 회원 이름을 통해 로그인 성공여부를 판단한다. 판단 후 출력할 메세지
		// 이름을 request 영역에 저장한다.
		...
		} else
		{
			/*
			 	...
			 	최고관리자인지 재확인한다. 만약 최고관리자도 아니라면 비회원이라
			 	판단할 수 있다.
			*/

...
create sequence seq_user1_num
    ...
    nocycle         -- 순환하지 않음
    nocache;        -- 캐시 안 함
drop sequence seq_user1_num;

create sequence seq_board1_num
    increment by 1  -- 1씩 증가
    start with 1    -- 시작값 1
    minvalue 1      -- 최소값 1
    nomaxvalue      -- 최대값은 무한대
    nocycle         -- 순환하지 않음
    nocache;        -- 캐시 안 함
drop sequence seq_board1_num;

create sequence seq_comment1_num
    increment by 1  -- 1씩 증가
    start with 1    -- 시작값 1
    minvalue 1      -- 최소값 1
    nomaxvalue      -- 최대값은 무한대
    nocycle         -- 순환하지 않음
    nocache;        -- 캐시 안 함
drop sequence seq_comment1_num;
...
select seq_comment1_num.nextval from dual;
desc board1;